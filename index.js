...
(function(){
  ...
  ref$ = squeak = require('./squeak'), squeakSet = ref$.squeakSet, squeakGet = ref$.squeakGet, icomplain = ref$.icomplain, complain = ref$.complain, iwarn = ref$.iwarn, ierror = ref$.ierror, warn = ref$.warn, error = ref$.error, aerror = ref$.aerror, icomplainOpts = ref$.icomplainOpts, complainOpts = ref$.complainOpts, iwarnOpts = ref$.iwarnOpts, ierrorOpts = ref$.ierrorOpts, warnOpts = ref$.warnOpts, errorOpts = ref$.errorOpts, aerrorOpts = ref$.aerrorOpts;
